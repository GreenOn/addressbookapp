	...
	if(jQuery(window).width() > 1006) {
		...
		function _topNavCalibrate() {
			...
			if(jQuery("#topHead").length > 0) {
				...
				console.log(window._headHeight);
 ...
 **************************************************************** **/
	function _globalSearch() {
		console.log("Search clicked" + jQuery('li.search').length);
...
*************************************************** **/
	...
	function showMap(initWhat) {
		...
		script.src 		= 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBgVYzGGAGHVvcQlY8PVDT7_io00idrGIA&sensor=true&callback='+initWhat;
